...
label6 = tk.Label(all_india, text=attributes[3]+" : "+allFigures["All India"][3], bg=India_Inner_bg, fg="black", font=("Courier", 25, "bold")).place(x=5, y=290)  # All India -> Deceased attribute and value label

# Drawing state wise section
# State wise outer Canvas
State_Outer_bg = "lavender"
...
label8 = tk.Label(state_inner, text=combo_box.get(), font=("Roman", 25, "bold"), bg=State_Inner_bg)  # Label for displaying name of current selection
label8.place(x=510, y=65)
label9 = tk.Label(state_inner, text=attributes[0]+" : "+allFigures["All India"][0], bg=State_Inner_bg, fg="firebrick1", font=("Roman", 20, "bold"))  # State wie -> Confirmed attribute and value label
